...
public class MemoryKarte extends Button {
	...
	//NEU nur umgedreht
	private boolean schummelnUmgedreht;
	...
	//Die Karte wird NUR umgedreht
	//Es wird also nur die Vorderseite gezeigt (GUI),
	//Die Karte bleibt aber verdeckt (Logik)
	public void nurZeigenVorne() {
		setGraphic(bildVorne);
		schummelnUmgedreht = true;
	}
	//Die Karte wird NUR umgedreht
	//Es wird also nur die Hinterseite gezeigt (GUI)
	public void reset() {
			setGraphic(bildHinten);
			schummelnUmgedreht = false;
	...
	public boolean isSchummelnUmgedreht() {
		return schummelnUmgedreht;
	}
